...
function maybeNumber(value: unknown, field: string): number | undefined {
  ...
  if (typeof value !== 'number') {
    throw new Error(`Forge: bridge.yaml ${field} must be a number`);
  }
  return value;
}
...
function maybeBoolean(value: unknown, field: string): boolean | undefined {
  ...
  if (typeof value !== 'boolean') {
    throw new Error(`Forge: bridge.yaml ${field} must be a boolean`);
  }
  return value;
}
...
function maybeString(value: unknown, field: string): string | undefined {
  ...
  if (typeof value !== 'string' || !value.trim()) {
    throw new Error(`Forge: bridge.yaml ${field} must be a non-empty string`);
  }
  return value;
}
...
function maybeReasoningEffort(
  value: unknown,
  field: string,
): ModelConfig['reasoning_effort'] | undefined {
      ...
      typeof sampling.stop === 'string'
        ...
        : Array.isArray(sampling.stop)
          ...
          : sampling.stop === undefined
            ? undefined
            : (() => {
                throw new Error(`Forge: bridge.yaml models.${modelName}.sampling.stop must be a string or array of strings`);
              })(),
