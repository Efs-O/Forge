...
| Sidebar dismisses when an approval is resolved remotely | pass (fixed, retested 2026-08-30) |
| Approval replay rejected as stale | pass (retested 2026-08-30) |
| `/stop` with queued work behind it | pass (retested 2026-08-30) |
| Unpaired-account and group rejection | pass (retested 2026-08-30) |
