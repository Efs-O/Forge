...
- `microsoft/vscode-docs` — auto-rendered to the docs site above
...
| Gemma 4 collection (HF) | https://huggingface.co/google                                  | Multimodal variants exist; tool-call quirks documented in `llamabridge/CONTINUE_PATCH_NOTE.md` |
...
| `hallumeter`                  | https://github.com/Efs-O/hallumeter                            | Tauri context-fill overlay; complementary tool, see [11-hallumeter.md](11-hallumeter.md) |

### In-tree reference files
- `llamabridge/README.md` — bridge usage, troubleshooting, flag semantics
- `llamabridge/CONTINUE_PATCH_NOTE.md` — Continue tool-schema lesson (informs Forge tool design)
...
- `docs/10-bridge-audit.md` — our audit + lift list
...
| Chroma "Context Rot" study (2025) | (track via HalluMeter `RESEARCH.md`)                           | All 18 models degrade with context fill            |
| HalluMeter `RESEARCH.md`          | https://github.com/Efs-O/hallumeter                            | Calibrated degradation curves we may reuse         |
...
| GitHub Releases               | https://github.com/Efs-O/forge/releases                        | `.vsix` downloads, source archives               |
